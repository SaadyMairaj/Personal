...
class TwoArm(Frame):
    ...
    def WriteToExcelFile(self, window):
        ...
        try:
            ...
            worksheet.write_string(7, 0, Heading[0], WrapText)
            worksheet.write_string(7, 1, Heading[1], WrapText)
            worksheet.write_string(7, 2, Heading[2], WrapText)
            worksheet.write_string(7, 3, Heading[2], WrapText)
